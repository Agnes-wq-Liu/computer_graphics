...
public class BasicPipeline {
    ...
    public int lightColorID1;
    public int lightDirID2;
    public int lightColorID2;
    public int lightDirID3;
    public int lightColorID3;
    
    public int HalfVector1ID;
    public int HalfVector2ID;
    public int HalfVector3ID;
...
//    public int StrengthID;
	...
	public BasicPipeline( GLAutoDrawable drawable ) {
        ...
        lightColorID1 = gl.glGetUniformLocation( glslProgramID, "lightColor1" );
        lightDirID2 = gl.glGetUniformLocation( glslProgramID, "lightDir2" );
        lightColorID2 = gl.glGetUniformLocation( glslProgramID, "lightColor2" );
        lightDirID3 = gl.glGetUniformLocation( glslProgramID, "lightDir3" );
        lightColorID3 = gl.glGetUniformLocation( glslProgramID, "lightColor3" );
        
        ShininessID = gl.glGetUniformLocation( glslProgramID, "Shininess" );
        
        HalfVector1ID = gl.glGetUniformLocation( glslProgramID, "HalfVector1" );
        HalfVector2ID = gl.glGetUniformLocation( glslProgramID, "HalfVector2" );
        HalfVector3ID = gl.glGetUniformLocation( glslProgramID, "HalfVector3" );
        ...
        negCamPosID = gl.glGetUniformLocation( glslProgramID, "negCamPos" );
	}
	...
	public void enable( GLAutoDrawable drawable ) {
        ...
        gl.glUniform3f(kdID, (float) 1, (float) 1, (float) 1);
        gl.glUniform3f(ksID, (float) 1, (float) 1, (float) 1);
        gl.glUniform3f(AmbientID, (float) 0.08, (float) 0.05, (float) 0.02);
        gl.glUniform1f(ShininessID, (float) 400);

        Vector3f lightDir1 = new Vector3f( 200, 200, 200 );
        lightDir1.normalize();
        gl.glUniform3f( lightDirID1, lightDir1.x, lightDir1.y, lightDir1.z );
        Vector3f lightColor1 = new Vector3f( 1,1,1);
        gl.glUniform3f( lightColorID1, lightColor1.x, lightColor1.y, lightColor1.z );
        
        Vector3f lightDir2 = new Vector3f( 5, 0, 0 );
        lightDir2.normalize();
        gl.glUniform3f( lightDirID2, lightDir2.x, lightDir2.y, lightDir2.z );
        Vector3f lightColor2 = new Vector3f(1,1,1);
        gl.glUniform3f( lightColorID2, lightColor2.x, lightColor2.y, lightColor2.z );
        
        Vector3f lightDir3 = new Vector3f( 0, 0, 10);
        lightDir3.normalize();
        gl.glUniform3f( lightDirID3, lightDir3.x, lightDir3.y, lightDir3.z );
        Vector3f lightColor3 = new Vector3f(1,1,1);
        gl.glUniform3f( lightColorID3, lightColor3.x, lightColor3.y, lightColor3.z );
        
        
        
        Vector3f neg_cam_pos = new Vector3f((float)VMatrix.m03,(float)VMatrix.m13,(float)VMatrix.m23);
        gl.glUniform3f(negCamPosID, neg_cam_pos.x, neg_cam_pos.y, neg_cam_pos.z);
	}
...
//		throw new RuntimeErrorException( new Error("stack overflow") );
	...
	public void pop() {
		...
		MMatrix.set(mstack.pop()); 
		MinvTMatrix.set(mstack.pop());
	...
	public void scale( double x, double y, double z ) {
		...
		Matrix4d tmp = new Matrix4d(x,0,0,0,
									0,y,0,0,
									0,0,z,0,
									0,0,0,1);
		tmpMatrix4d.set(tmp);
