...
public class A2App implements GLEventListener {
    ...
    public A2App() {
        ...
        String windowName = "ArcBall and Shadow Maps - Agnes Liu 260713093";
        ...
        glCanvas.setSize(500,500); // 640x360 for half 720p resolution would be nice, but need to fix projection windowing transformation.
